...
(() => {
  ...
  var hasMultipleThemes = (themesList) => themesList.length > 1, hasTwoThemes = (themesList) => themesList.length === 2, ThemeSwitcher = react_default.memo(function() {
    ...
    if (hasTwoThemes(themesList)) {
      ...
      return react_default.createElement(
        ...
        react_default.createElement(PaintBrushIcon, null),
        label
      );
    }
    return hasMultipleThemes(themesList) ? react_default.createElement(
      Select,
      {
        icon: react_default.createElement(PaintBrushIcon, null),
        ariaLabel,
        disabled: isLocked,
        key: THEME_SWITCHER_ID,
